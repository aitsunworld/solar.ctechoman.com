document.addEventListener('DOMContentLoaded', () => {
    ...
    const APPLIANCE_IMAGES = {
        window_ac: 'img/appliances/window_ac.png',
        ac_1ton: 'img/appliances/ac_1ton.png',
        ac_1_5ton: 'img/appliances/ac_1_5ton.png',
        ac_2ton: 'img/appliances/ac_2ton.png',
        refrigerator: 'img/appliances/refrigerator.png',
        freezer: 'img/appliances/freezer.png',
        washing_machine: 'img/appliances/washing_machine.png',
        water_heater: 'img/appliances/water_heater.png',
        tv: 'img/appliances/tv.png',
        led_lights: 'img/appliances/led_lights.png',
        ceiling_fan: 'img/appliances/ceiling_fan.png',
        microwave: 'img/appliances/microwave.png',
        electric_oven: 'img/appliances/electric_oven.png',
        water_pump: 'img/appliances/water_pump.png',
        dishwasher: 'img/appliances/dishwasher.png',
        desktop_pc: 'img/appliances/desktop_pc.png',
        laptop: 'img/appliances/laptop.png',
        ev_charger: 'img/appliances/ev_charger.png',
        // Commercial
