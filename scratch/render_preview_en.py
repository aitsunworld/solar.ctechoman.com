...
def render():
    ...
    # Load lang/en
    lang = parse_php_array(os.path.join(workspace, "lang", "en.php"))
    
    # Re-inject variables if referenced
    ...
    # Keep if blocks for English (replace with \1)
    ...
    # Keep else blocks for English (replace with \2)
    ...
    preview_path = os.path.join(workspace, "preview.html")
    with open(preview_path, 'w', encoding='utf-8') as f:
        f.write(html)
        
    print(f"Successfully rendered preview.html with {len(html)} bytes.")
